...
describe("Our Demo Token", function () {
  ...
  beforeEach(async function() {
    const DemoToken = await hre.ethers.getContractFactory("MyToken");
    demoToken = await MyToken.deploy();
  ...
  it("Should deploy with 10k of supply for the owner of the contract", async function() {
